Feature: ck/step2-fieldValidation-firstName.feature
  ...
  Scenario: 6 - User enters invalid First Name with multiple special characters
    When I have enter invalid "firstName" value "hal--stone" that "contains a number"
    Then I shall be displayed an error for the "firstName" field - "First Name may not include numbers or special characters." in red

  Scenario: 7 - User enters invalid First Name not starting with a letter
    When I have enter invalid "firstName" value "-stone" that "does not begin with a letter"
    Then I shall be displayed an error for the "firstName" field - "First Name may not include numbers or special characters." in red

  Scenario: 8 - User enters an valid firstName
  ...
  Scenario: 9 - User enters an invalid firstName
  ...
  Scenario: 10 - User enters invalid characters in First Name multiple input errors
  ...
  Scenario: 11 - User enters additional invalid characters in First Name multiple input errors
