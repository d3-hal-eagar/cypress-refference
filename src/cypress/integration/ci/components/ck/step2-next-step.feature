...
covers
    ...
    Scenario: 2 - User submits form with incomplete information
        ...
        And The "account-created-section" message contains "By clicking on "Whoops! Looks like we’re missing some important information. You may have tried to continue to the next step too soon or missed a required field. Please ensure you've provided all of the required information before continuing. Missed entries are highlighted in red."
    ...
    Scenario: 2 - User submits form but is too young
        ...
        And I select "02" on the "dobMonth" field
        And I select "23" on the "dobDay" field
        And I select "2003" on the "dobYear" field
        And I have enter valid "ssn" value "7896"
        And I click element "agreement"
        And I click element "next-step-button"
        Then I am guided to the ck step2 form page
    ...
    Scenario: 1 - User submits form with valid information
        ...
        Then Action detail "current dev must always provide full ssn"
