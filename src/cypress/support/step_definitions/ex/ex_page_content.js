...
(function() {
    ...
    Then(`I am displayed the correct blocks on the ex Step 2 right rail`, () => {
        ...
        cy.get('@_flow_specific').then((flow_specific) => {
            ...
            //Description:
            cy.getElement('aside-order').find('h3').contains(flow_specific.siteName+' Basic $0.00');
            ...
            cy.getElement('aside-order').find('li').contains('* Includes New Inquiries, New Accounts, Public Records, Fraud Alerts and Personal Information updates when added to your '+flow_specific.siteName+' Credit Report');
            // Header:
            cy.getElement('aside-secure').find('h4').contains('Privacy Policy Notice');
            //Description:
            cy.getElement('aside-secure').find('p').contains(flow_specific.siteName + '\'s policy on how your personal information is used and disclosed is contained in our Privacy Policy. This product is Web-based and you agree to accept this notification, revisions, and the provision of an annual notice electronically through this website, if required.');
    ...
    Then(`I am displayed the right rail Order Summary block`, () => {
        //cy.get('@_flow_specific').then((flow_specific) => {
            ...
            //Description:
            // cy.get('.col-lg-5 [data-test=aside-order] ul').contains('Free '+flow_specific.siteName+' Credit Report');
